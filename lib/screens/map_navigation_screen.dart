...
class MapNavigationController extends GetxController
  ...
  MapNavigationController({
    ...
    Future<LocationResult> Function({bool forceRefresh})? locationProvider,
  }) : _navigationService = navigationService ?? NavigationService(),
       _ownsNavigationService = navigationService == null,
       _locationProvider =
           locationProvider ?? LocationService.getCurrentLocationResult;

  final NavigationService _navigationService;
  final bool _ownsNavigationService;
  final Future<LocationResult> Function({bool forceRefresh}) _locationProvider;
  ...
  Future<void> loadCurrentLocation() async {
    ...
    _clearError();
    final result = await _locationProvider(forceRefresh: true);
  ...
  Future<void> findRoute() async {
    ...
    try {
      ...
      if (requestGeneration != _routeRequestGeneration ||
          destinationController.text.trim() != requestedDestination) {
        return;
      }
